module SimpleBreadcrumb
  ...
  class CrumbContainer
    ...
    def initialize(options = {})
      @html_tag = options[:html_tag] || SimpleBreadcrumb::Config.container_tag
      @html_wrapper_tag = options[:html_wrapper_tag] || SimpleBreadcrumb::Config.container_wrapper_tag
